...
with open('Breast_model_optimized.tflite', 'wb') as f:
    f.write(tflite_model)

# Print size comparison
original_size = os.path.getsize('Breast.keras') / (1024 * 1024)
new_size = os.path.getsize('Breast_model_optimized.tflite') / (1024 * 1024)
